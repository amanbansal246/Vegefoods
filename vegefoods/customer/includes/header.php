					    ...
					    <div class="col-md-5 pr-2 d-flex topper align-items-center text-lg-right">
							<ul class="nav">
								...
								if(!isset($_SESSION['customer_email']))
								{
									...
									echo "<a href='../my_account.php' class='nav-link text-white'>My Account</a>";
								}
								?>
								</li>
								...
								<li class="nav-item"><a href="../customer_register.php" class="nav-link text-white">Register</a></li>
							</ul>
						</div>
				    </div>
			    </div>
