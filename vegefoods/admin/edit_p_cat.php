...
if(isset($_REQUEST['submit']))
{
  ...
  $sql="update product_categories set product_title='$pro_title',product_desc='$pro_desc' where p_cat_id=' $edit_cat_id '";

  $run_product=$conn->query($sql);
  if($run_product)
  {
    echo "<script>alert('Product Categories Updated Successfully')</script>";
    echo "<script>window.open('index.php?view_product_cat')</script>";
  }else{
    echo "failed";
  }
}
