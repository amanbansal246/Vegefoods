...
if(isset($_REQUEST['submit']))
{
  ...
  $sql = "insert into products (p_cat_id,date,product_title,product_img,product_price,product_desc,product_keyword) values ('$pro_category','now()','$pro_title','$file_name','$pro_price','$pro_desc','$pro_keyword')";
